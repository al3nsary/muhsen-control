...
const NAV = [
  ...
  { g:'الموظفون', items:[
    ...
    { k:'assign', i:'i-users', l:'التشكيل',       d:'مشرفون وليدرز ومحسنون — ثلاث خطوات' },
    { k:'build',  i:'i-swap',  l:'التشكيل السريع', d:'مجموعة كاملة في صندوق واحد' },
    { k:'orgs',   i:'i-flag',  l:'الجهات والفنادق', d:'تُضاف وتُعدَّل — ويقرؤها النظام' }
  ]},
